 ...
 */
#define LINE_LED0                   PAL_LINE(GPIOC, 9)
#define LINE_LED1                   PAL_LINE(GPIOA, 8)
#define LINE_LED2                   PAL_LINE(GPIOA, 9)
#define LINE_LED3                   PAL_LINE(GPIOA, 10)

#define LINE_ROW1                   PAL_LINE(GPIOA, 0)
#define LINE_ROW2                   PAL_LINE(GPIOA, 1)
#define LINE_ROW3                   PAL_LINE(GPIOA, 2)
#define LINE_ROW4                   PAL_LINE(GPIOA, 3)
#define LINE_ROW5                   PAL_LINE(GPIOA, 4)
#define LINE_ROW6                   PAL_LINE(GPIOA, 5)
#define LINE_ROW7                   PAL_LINE(GPIOA, 6)

#define LINE_COL1                   PAL_LINE(GPIOC, 4)
#define LINE_COL2                   PAL_LINE(GPIOC, 5)
#define LINE_COL3                   PAL_LINE(GPIOB, 0)
#define LINE_COL4                   PAL_LINE(GPIOB, 1)
#define LINE_COL5                   PAL_LINE(GPIOB, 2)
#define LINE_COL6                   PAL_LINE(GPIOB, 10)
#define LINE_COL7                   PAL_LINE(GPIOB, 11)
#define LINE_COL8                   PAL_LINE(GPIOB, 12)
#define LINE_COL9                   PAL_LINE(GPIOB, 13)
#define LINE_COL10                  PAL_LINE(GPIOB, 14)
#define LINE_COL11                  PAL_LINE(GPIOB, 15)
#define LINE_COL12                  PAL_LINE(GPIOC, 6)
#define LINE_COL13                  PAL_LINE(GPIOC, 7)
#define LINE_COL14                  PAL_LINE(GPIOC, 10)
#define LINE_COL15                  PAL_LINE(GPIOC, 11)
#define LINE_COL16                  PAL_LINE(GPIOC, 12)
